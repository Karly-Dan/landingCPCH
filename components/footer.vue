...
<div style="display: flex;">
    ...
    <div style="padding: 4px;">
        <h1 style="font-size: 25px; color: #1187ce;">Contactanos</h1>
        <img src="../assets/llamada.png" alt="" style="position: absolute; margin-top: -3px;">
        <p style="position: relative; margin-left: 30px;">5512543594</p>
        <p style="cursor: pointer;">Revisa nuestro aviso de privacidad aqui</p>
    </div>
</div>
</template>
